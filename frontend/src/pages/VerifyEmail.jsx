  ...
  return (
    <div className="min-h-screen bg-radial-[at_50%_20%] from-[#111827] via-[#090d16] to-[#03050a] flex flex-col justify-center items-center px-4 py-16 relative overflow-hidden font-sans">
      ...
      <motion.div
        ...
        className="w-full max-w-[440px] flex flex-col bg-gradient-to-b from-[#1e293b]/50 to-[#0f172a]/60 border border-white/[0.07] rounded-[32px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.8)] p-8 sm:p-10 backdrop-blur-3xl relative z-10"
      >
